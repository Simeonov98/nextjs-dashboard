...
export default function BoardClient({ initialCards,user }: { initialCards: CardsType[],user:users }) {
    const [cards, setCards] = useState(initialCards)
    // setCards(initialCards)

    return (
        <div className="flex h-full w-full gap-3 overflow-scroll p-12">
            <Column title="Backlog" column="backlog" headingColor="text-neutral-600" cards={cards} setCards={setCards} user={user}/>
